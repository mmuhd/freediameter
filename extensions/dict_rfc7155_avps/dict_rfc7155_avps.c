...
static int dict_rfc7155_avps_load_defs(char * conffile)
{
   ...
   /* AVP section */
   {
		...
		/* NAS-Port-Type */
		{
			...
			struct dict_type_data     tdata = { AVP_TYPE_UNSIGNED32, "Enumerated(NAS-Port-Type)", NULL, NULL, NULL };
			struct dict_enumval_data        t_1 = { "ASYNC", { .u32=0 }};
			struct dict_enumval_data        t_2 = { "SYNC", { .u32=1 }};
			struct dict_enumval_data        t_3 = { "ISDN_SYNC", { .u32=2 }};
			struct dict_enumval_data        t_4 = { "ISDN_ASYNC_V120", { .u32=3 }};
			struct dict_enumval_data        t_5 = { "ISDN_ASYNC_V110", { .u32=4 }};
			struct dict_enumval_data        t_6 = { "VIRTUAL", { .u32=5 }};
			struct dict_enumval_data        t_7 = { "PIAFS", { .u32=6 }};
			struct dict_enumval_data        t_8 = { "HDLC_CLEAR_CHANNEL", { .u32=7 }};
			struct dict_enumval_data        t_9 = { "X25", { .u32=8 }};
			struct dict_enumval_data        t_10 = { "X75", { .u32=9 }};
			struct dict_enumval_data        t_11 = { "G.3_FAX", { .u32=10 }};
			struct dict_enumval_data        t_12 = { "SDSL_SYMMETRIC_DSL", { .u32=11 }};
			struct dict_enumval_data        t_13 = { "IDSL_ISDN_DIGITAL_SUBSCRIBER_LINE", { .u32=14 }};
			struct dict_enumval_data        t_14 = { "ETHERNET", { .u32=15 }};
			struct dict_enumval_data        t_15 = { "XDSL_DIGITAL_SUBSCRIBER_LINE_OF_UNKNOWN_TYPE", { .u32=16 }};
			struct dict_enumval_data        t_16 = { "CABLE", { .u32=17 }};
			struct dict_enumval_data        t_17 = { "WIRELESS_OTHER", { .u32=18 }};
			struct dict_enumval_data        t_18 = { "WIRELESS_IEEE_802.11", { .u32=19 }};
			struct dict_enumval_data        t_19 = { "TOKEN_RING", { .u32=20 }};
			struct dict_enumval_data        t_20 = { "FDDI", { .u32=21 }};
			struct dict_enumval_data        t_21 = { "WIRELESS_CDMA2000", { .u32=22 }};
			struct dict_enumval_data        t_22 = { "WIRELESS_UMTS", { .u32=23 }};
			struct dict_enumval_data        t_23 = { "WIRELESS_1X_EV", { .u32=24 }};
			struct dict_enumval_data        t_24 = { "IAPP", { .u32=25 }};
			struct dict_enumval_data        t_25 = { "FTTP_FIBER_TO_THE_PREMISES", { .u32=26 }};
			struct dict_enumval_data        t_26 = { "WIRELESS_IEEE_802.16", { .u32=27 }};
			struct dict_enumval_data        t_27 = { "WIRELESS_IEEE_802.20", { .u32=28 }};
			struct dict_enumval_data        t_28 = { "WIRELESS_IEEE_802.22", { .u32=29 }};
			struct dict_enumval_data        t_29 = { "PPPOA_PPP_OVER_ATM", { .u32=30 }};
			struct dict_enumval_data        t_30 = { "PPPOEOA_PPP_OVER_ETHERNET_OVER_ATM", { .u32=31 }};
			struct dict_enumval_data        t_31 = { "PPPOEOE_PPP_OVER_ETHERNET_OVER_ETHERNET", { .u32=32 }};
			struct dict_enumval_data        t_32 = { "PPPOEOVLAN_PPP_OVER_ETHERNET_OVER_VLAN", { .u32=33 }};
			struct dict_enumval_data        t_33 = { "PPPOEOQINQ_PPP_OVER_ETHERNET_OVER_IEEE_802.1QINQ", { .u32=34 }};
			struct dict_enumval_data        t_34 = { "XPON_PASSIVE_OPTICAL_NETWORK", { .u32=35 }};
			struct dict_enumval_data        t_35 = { "WIRELESS_XGP", { .u32=36 }};
